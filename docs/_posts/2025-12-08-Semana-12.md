...
Esta semana el objetiva ha sido el de crear:
...
Todas estas modificaciones o mejoras se han realizado sobre el script vehicle.py de nuestro BRAIN, creado en la semana X.
